...
import static com.nhnacademy.test.Iterators.generate;
import static com.nhnacademy.test.Iterators.reduce;
...
public class Mathx {
    ...
    public static <T extends Enum<T>> Iterator<Integer> discreteUniformDistribution(Class<T> enumType) {
